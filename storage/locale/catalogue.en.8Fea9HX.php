...
',
    ...
    'maicol07-sso.admin.settings.provider_mode' => 'Enable this option to use the provider mode (SSO between Flarum instances). Allows other Flarum instances to login an user of this Flarum instance. This will disable the standard SSO feature with other websites.',
    'maicol07-sso.admin.settings.client_name' => 'Name',
    'maicol07-sso.admin.settings.client_name_help' => 'Name of the Flarum instance',
    'maicol07-sso.admin.settings.client_url' => 'URL',
    'maicol07-sso.admin.settings.client_url_help' => 'URL of the Flarum instance',
    'maicol07-sso.admin.settings.client_api_key' => 'API key',
    'maicol07-sso.admin.settings.client_api_key_help' => 'The API key from your Flarum instance.',
    'maicol07-sso.admin.settings.client_password_token' => 'Password token',
    'maicol07-sso.admin.settings.client_password_token_help' => 'A random password token to use with the Flarum instance signups.',
    'maicol07-sso.admin.settings.client_verify_ssl' => 'Verify SSL',
    'maicol07-sso.admin.settings.client_verify_ssl_help' => 'Verify the Flarum instance SSL status when making requests to it (recommended).',
    ...
    'maicol07-sso.admin.settings.cookies_prefix' => 'Cookies name prefix',
    ...
    'maicol07-sso.forum.no_login_url_error' => 'No login URL set, please check the SSO settings!',
